((self) => { 'use strict';
    ...
    domForEach(src, (dom) => {
      ...
      let onstart = function(evt) {
        ...
        let onspin = (evt) => {
          ...
          lastDeg = realDeg;
          if (!fixed) { this.style.transform = ('rotate('+realDeg+'deg)'); }
        ...
        let onend = (evt) => {
          ...
          document.removeEventListener('mousemove', onspin);
          document.removeEventListener('touchmove', onspin);
        ...
        document.addEventListener('mousemove', onspin);
        document.addEventListener('touchmove', onspin);
  ...
  knob.setDegree = (src, deg) => domForEach(src, (dom) => {
    ...
    if (!knob.getFixed(dom)) { dom.style.transform = ('rotate('+deg+'deg)'); }
  });
